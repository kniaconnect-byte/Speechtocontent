...
const HOOKS_60 = [
  {name:"Relatable",desc:"Bikin audiens langsung bilang 'ini aku banget'.",keywords:["capek","susah","struggle","belajar","dulu","gagal","salah","lama","disiplin","lost","bingung","nyerah","waktu","fokus","pelan"],items:["Aku buang 2 tahun buat belajar ini","Andai ada yang kasih tau aku dari dulu","Nggak ada yang ngingetin aku soal ini","Kalau mulai dari awal lagi, ini yang bakal aku lakuin","Akhirnya aku nemuin jawabannya","Ini yang butuh waktu lama banget buat aku pelajarin","Aku juga dulu struggle sama ini","Satu keputusan yang ubah masa depan aku","Ini yang bikin aku lebih disiplin","Kalau kamu lagi ngerasa lost, baca ini","Aku belajar ini dengan cara yang susah","Ini yang bikin aku tetep fokus"]},
  {name:"Curiosity Gap",desc:"Buka celah info yang bikin penasaran.",keywords:["rahasia","ternyata","gimana caranya","kenapa","mitos","jarang","tersembunyi","nggak ada yang tau","underrated"],items:["Nggak ada yang ngomongin ini...","Internet bohongin kamu soal...","Kedengerannya kayak ga mungkin, tapi ini beneran works","Ini alasan kenapa orang stuck di situ-situ aja","Ini bagian yang nggak pernah ditunjukin orang","Kebanyakan creator ngelewatin ini","Nggak ada yang nyangka hasilnya bakal gini","Strategi ini underrated banget","Kamu mungkin lagi ngabaikan ini","Ini alasan kenapa kamu ngerasa nggak termotivasi"]},
  {name:"Urgency",desc:"Maksa perhatian saat ini juga.",keywords:["sekarang","jangan","penting","harus","segera","sebelum","hari ini","pemula","kesalahan","deadline"],items:["Baca ini dulu sebelum mulai","Jangan lakuin kesalahan pemula ini","Ini tanda buat kamu mulai","Kamu perlu denger ini hari ini","Mulai dari ini dulu"]},
  {name:"Value Promise",desc:"Janji hemat waktu / hasil jelas.",keywords:["hemat","cepat","gampang","mudah","tips","cara","trik","hasil","mindset","kebiasaan","produktif","menit","simple","efektif"],items:["Ini yang langsung ubah mindset aku","Satu kebiasaan ini yang ubah semuanya","Biar aku hemat waktu kamu","Perubahan kecil. Hasil gede.","Kamu cuma butuh 10 menit buat ini","Ini bisa benerin konsistensi kamu","Simpen ini buat nanti","Ini bakal bikin hidup kamu lebih gampang","Ini cara yang lebih smart buat ngelakuinnya","Ini cara simplify semuanya","Ini game changer yang sebenernya","Ini yang hemat waktu aku berjam-jam tiap minggu","Satu mindset shift ini yang paling penting"]},
  {name:"Contrarian / Myth-Busting",desc:"Bongkar mitos, ambil sisi berlawanan.",keywords:["salah kaprah","mitos","bukan","jangan niru","overthinking","bakat","motivasi","padahal"],items:["Kamu bikin ini makin susah dari yang sebenarnya","Kamu ga butuh motivasi, tapi kamu butuh ini","Berhenti niru orang lain","Kebiasaan ini yang ngerusak progress kamu","Lakuin ini daripada overthinking","Ini lebih penting daripada bakat"]},
  {name:"Social Proof",desc:"Kredibilitas & hasil nyata.",keywords:["works","terbukti","hasil nyata","aku coba","pengalaman","testimoni","berhasil","bukti"],items:["Trik ini works tiap kali dicoba","Aku coba sendiri dan buktiin ini","Ini yang beneran works","Aku sendiri nggak nyangka ini bisa works","Aku berhenti ngelakuin ini dan langsung improve","Ini yang bikin aku lebih produktif dalam semalam"]},
  {name:"Motivational",desc:"Dorongan semangat buat mulai aksi.",keywords:["semangat","nyerah","mulai","mimpi","usaha","progress","gagal","yakin"],items:["Kamu lebih deket dari yang kamu kira","Kebanyakan orang nyerah terlalu cepat","Coba ini dulu sebelum nyerah","Diri kamu di masa depan bakal berterima kasih","Bagian tersusah itu cuma di awal mulainya"]},
  {name:"Reassurance",desc:"Rasa tenang, validasi belum sempurna.",keywords:["gapapa","nggak apa-apa","males","belum sempurna","tenang","santai","capek"],items:["Kamu nggak perlu sempurna","Ini works walaupun kamu lagi males"]}
];
